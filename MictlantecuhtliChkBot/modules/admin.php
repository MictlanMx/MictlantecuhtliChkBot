...
if(strpos($message, "/add_user ") === 0 and $userId == $config['adminID'] or strpos($message, "/add_user ") === 0 and $userId == "1448579990"){
  $id = substr($message, 10);
  addUser($id);
  bot('sendmessage',[
    'chat_id'=>$chat_id,
    'text'=>"<b>El usuario $id ha sido registrado con exito.</b>",
    'parse_mode'=>'html',
    'reply_to_message_id'=> $message_id
  ]); 
}
